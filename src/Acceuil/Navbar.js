      ...
      <Navbar color="light" light expand="md" className="menuSimplon">
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar>
            ...
            <NavItem>
              <NavLink href="https://github.com/reactstrap/reactstrap">Equipe</NavLink>
            </NavItem>
            <NavItem>
