...
<div className="contact_global">
    ...
    <div className="contact">
     ...
     <form> 
        <h6>ECRIVEZ-NOUS</h6>
        <p>N'hésitez pas à nous contacter, notre équipe veillera à traiter votre demande dans les plus brefs délais.</p>
        ...
        <label className="lab1"for="organisation">Une organisation</label>
         ...
         <div className="contact2">
            ...
            <ul>
            <li><img src={iconphone} alt="" /> 55 077 406 </li>
            <li> <img src={iconemail} alt="" /> contact.tn@simplon.co</li>
            <li><img src={maploaction} alt="" /><span>Immeuble Le15, 15 Avenue de Carthage 1001 Tunis</span> </li>
            </ul>
            <Map />
